...
<head>
    ...
    <title>Alta de libro - Admin</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="container">
                    <div>
                        <h5>*Escribe los datos del libros en los campos correspondientes para agregar</h5>
                    </div>
                    <form class="p-5" method="POST" action="../controllers/book_entry.php">
                        <div class="row">
